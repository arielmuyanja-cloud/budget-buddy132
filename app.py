...
# ================= OPENAI =================
client = OpenAI(api_key="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")

# ================= APP =================
app = Flask(__name__)
app.secret_key = "budgetbuddy_secret"
...
# ================= RUN =================
if __name__ == '__main__':
>>>>>>> 2ee18e8fd330d8e3ae2c5af2304e639402bcdda6
    app.run(debug=True)